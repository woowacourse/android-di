...
abstract class ApplicationModule(val applicationContext: Context) : Module() {
    ...
    companion object {
        ...
        fun <T : ApplicationModule> getPrimaryConstructor(moduleClassType: Class<T>): KFunction<T> {
        ...
        private fun <T : ApplicationModule> validatePrimaryConstructor(primaryConstructor: KFunction<T>) {

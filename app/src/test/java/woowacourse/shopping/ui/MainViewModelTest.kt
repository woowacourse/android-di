...
class MainViewModelTest {
    ...
    fun setUp() {
        ...
        cartRepository = FakeCartRepository(fakeCartProducts.toMutableList())

        mainViewModel.productRepository = productsRepository
    ...
    fun `모든_물품들을_조회한다`() {
        ...
        assertThat(
            value[1].imageUrl,
        ).isEqualTo("https://cdn-mart.baemin.com/sellergoods/main/52dca718-31c5-4f80-bafa-7e300d8c876a.jpg?h=700&w=700")
    }
